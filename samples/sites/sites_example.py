...
class SitesExample(object):
  ...
  def PromptSiteName(self):
    site_name = ''
    while not site_name:
      site_name = eval(input('site name: '))
      if not site_name:
        print('Please enter the name of your Google Site.')
    return site_name

  def PromptDomain(self):
    return eval(input(('If your Site is hosted on a Google Apps domain, '
  ...
  def Run(self):
    ...
    try:
      while True:
        ...
        if choice == 1:
          kind_choice = eval(input('What kind (all|%s)?: ' % '|'.join(
          ...
          page_title = eval(input('Enter a page title: '))
          ...
          url = eval(input('Enter the URL of the attachment: '))
          content_type = eval(input("Enter the attachment's mime type: "))
          title = eval(input('Enter a title for the web attachment: '))
          description = eval(input('Enter a description: '))
          ...
          filepath = eval(input('Enter a filename: '))
          page_title = eval(input('Enter a title for the file: '))
          description = eval(input('Enter a description: '))

          filename = os.path.basename(filepath)
          file_ex = filename[filename.rfind('.'):]
          if not file_ex in mimetypes.types_map:
            content_type = eval(input(
          ...
          title = eval(input('Enter a title: '))
          summary = eval(input('Enter a description: '))
          theme = eval(input('Theme name (ex. "default"): '))
